function statisticsFromGridDiv2HDF_v1(basename,first,last,dataNum)
...
dfields = {'u','v','w','ux','uy','uz','vx','vy','vz','wx','wy','wz','lambda1','lambda2',...
    'lambda3','wws','w2','cosss','cosww','coswl1','coswl2','coswl3','reldiv',...
    'ii','cosulambda1m','cosulambda2m','cosulambda3m','t'};
...
hfile = ['meanCorField_',int2str(dataNum),'.hdf'];
access = 'create';
...
for i = first:last
    ...
    clear f;
    fid = fopen('d:\0104_w\gridFilt.10021');
    f = textscan(fid,'%f');
