function collected_data = velocity_correlation_large_small1(filename)
% Usage:
...
for j = 1:numTraj
    ...
    if tf
        ...
        v_f_r = velocity_f * distance_r1'; % projection of small particle velocity on distance vector
        v_p_r = velocity_p * distance_r1'; % projection of large particle velocity on distance vector
       ...
       correlation_nn = v_f_n * v_p_n';
        ...
        collected_data(counter,2) = correlation_rr;
        collected_data(counter,3) = correlation_nn;
