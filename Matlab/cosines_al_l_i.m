                ...
                if ende<s(1,1)
                    for ii=start:ende
                        if age(ii)>tail & age(ii)<leng-tail+1 & reldiv(ii)<0.1
                            ...
                            statistic(counter,1)=(alx(ii)*V(1,1)+aly(ii)*V(2,1)+alz(ii)*V(3,1))/(absal(ii));
                            statistic(counter,2)=(alx(ii)*V(1,2)+aly(ii)*V(2,2)+alz(ii)*V(3,2))/(absal(ii));
                            statistic(counter,3)=(alx(ii)*V(1,3)+aly(ii)*V(2,3)+alz(ii)*V(3,3))/(absal(ii));
                            ...
                            if Q<-1 %pos diva
                                if (u(ii)*ax(ii)+v(ii)*ay(ii)+w(ii)*az(ii))/(absa(ii)*absu(ii))>0.7 %pos ua
                                    ...
                                    statistic(pos_diva_pos_ua_counter,4)=(alx(ii)*V(1,1)+aly(ii)*V(2,1)+alz(ii)*V(3,1))/(absal(ii));
                                    statistic(pos_diva_pos_ua_counter,5)=(alx(ii)*V(1,2)+aly(ii)*V(2,2)+alz(ii)*V(3,2))/(absal(ii));
                                    statistic(pos_diva_pos_ua_counter,6)=(alx(ii)*V(1,3)+aly(ii)*V(2,3)+alz(ii)*V(3,3))/(absal(ii));
                                ...
                                if (u(ii)*ax(ii)+v(ii)*ay(ii)+w(ii)*az(ii))/(absa(ii)*absu(ii))<-0.7 %neg ua
                                    ...
                                    statistic(pos_diva_neg_ua_counter,7)=(alx(ii)*V(1,1)+aly(ii)*V(2,1)+alz(ii)*V(3,1))/(absal(ii));
                                    statistic(pos_diva_neg_ua_counter,8)=(alx(ii)*V(1,2)+aly(ii)*V(2,2)+alz(ii)*V(3,2))/(absal(ii));
                                    statistic(pos_diva_neg_ua_counter,9)=(alx(ii)*V(1,3)+aly(ii)*V(2,3)+alz(ii)*V(3,3))/(absal(ii));
                            ...
                            if Q>1.5  
                                if Q<5 %neg diva weak
                                    ...
                                    statistic(neg_diva_weak_counter,10)=(alx(ii)*V(1,1)+aly(ii)*V(2,1)+alz(ii)*V(3,1))/(absal(ii));
                                    statistic(neg_diva_weak_counter,11)=(alx(ii)*V(1,2)+aly(ii)*V(2,2)+alz(ii)*V(3,2))/(absal(ii));
                                    statistic(neg_diva_weak_counter,12)=(alx(ii)*V(1,3)+aly(ii)*V(2,3)+alz(ii)*V(3,3))/(absal(ii));
                                ...
                                if Q>5 %neg diva strong
                                    ...
                                    statistic(neg_diva_strong_counter,13)=(alx(ii)*V(1,1)+aly(ii)*V(2,1)+alz(ii)*V(3,1))/(absal(ii));
                                    statistic(neg_diva_strong_counter,14)=(alx(ii)*V(1,2)+aly(ii)*V(2,2)+alz(ii)*V(3,2))/(absal(ii));
                                    statistic(neg_diva_strong_counter,15)=(alx(ii)*V(1,3)+aly(ii)*V(2,3)+alz(ii)*V(3,3))/(absal(ii));
