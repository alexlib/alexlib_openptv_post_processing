function background_motion_estimate_colloids(directory)
if nargin < 1
    % directory = '/Users/alex/Documents/PTV/ptv_alex/img_35_try';
    % directory = '/Users/alex/Documents/PTV/ptv_alex/img34_10';
    directory = '/Users/alex/Downloads/Image_for_alternative_detection';
end
for ncam = 4 %:4
...
% read the files
imlist = dir(sprintf('%s/filt_Cam%d.*',d,ncam));
