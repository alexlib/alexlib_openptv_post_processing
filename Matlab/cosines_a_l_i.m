                ...
                if ende<s(1,1)
                    for ii=start:ende
                        if age(ii)>tail & age(ii)<leng-tail+1 & reldiv(ii)<0.1
                            ...
                            statistic(counter,1)=(ax(ii)*V(1,1)+ay(ii)*V(2,1)+az(ii)*V(3,1))/(absa(ii));
                            statistic(counter,2)=(ax(ii)*V(1,2)+ay(ii)*V(2,2)+az(ii)*V(3,2))/(absa(ii));
                            statistic(counter,3)=(ax(ii)*V(1,3)+ay(ii)*V(2,3)+az(ii)*V(3,3))/(absa(ii));
                            ...
                            if Q<-1 %pos diva
                                if (u(ii)*ax(ii)+v(ii)*ay(ii)+w(ii)*az(ii))/(absa(ii)*absu(ii))>0.7 %pos ua
                                    ...
                                    statistic(pos_diva_pos_ua_counter,4)=(ax(ii)*V(1,1)+ay(ii)*V(2,1)+az(ii)*V(3,1))/(absa(ii));
                                    statistic(pos_diva_pos_ua_counter,5)=(ax(ii)*V(1,2)+ay(ii)*V(2,2)+az(ii)*V(3,2))/(absa(ii));
                                    statistic(pos_diva_pos_ua_counter,6)=(ax(ii)*V(1,3)+ay(ii)*V(2,3)+az(ii)*V(3,3))/(absa(ii));
                                ...
                                if (u(ii)*ax(ii)+v(ii)*ay(ii)+w(ii)*az(ii))/(absa(ii)*absu(ii))<-0.7 %neg ua
                                    ...
                                    statistic(pos_diva_neg_ua_counter,7)=(ax(ii)*V(1,1)+ay(ii)*V(2,1)+az(ii)*V(3,1))/(absa(ii));
                                    statistic(pos_diva_neg_ua_counter,8)=(ax(ii)*V(1,2)+ay(ii)*V(2,2)+az(ii)*V(3,2))/(absa(ii));
                                    statistic(pos_diva_neg_ua_counter,9)=(ax(ii)*V(1,3)+ay(ii)*V(2,3)+az(ii)*V(3,3))/(absa(ii));
                            ...
                            if Q>1.5  
                                if Q<5 %neg diva weak
                                    ...
                                    statistic(neg_diva_weak_counter,10)=(ax(ii)*V(1,1)+ay(ii)*V(2,1)+az(ii)*V(3,1))/(absa(ii));
                                    statistic(neg_diva_weak_counter,11)=(ax(ii)*V(1,2)+ay(ii)*V(2,2)+az(ii)*V(3,2))/(absa(ii));
                                    statistic(neg_diva_weak_counter,12)=(ax(ii)*V(1,3)+ay(ii)*V(2,3)+az(ii)*V(3,3))/(absa(ii));
                                ...
                                if Q>5 %neg diva strong
                                    ...
                                    statistic(neg_diva_strong_counter,13)=(ax(ii)*V(1,1)+ay(ii)*V(2,1)+az(ii)*V(3,1))/(absa(ii));
                                    statistic(neg_diva_strong_counter,14)=(ax(ii)*V(1,2)+ay(ii)*V(2,2)+az(ii)*V(3,2))/(absa(ii));
                                    statistic(neg_diva_strong_counter,15)=(ax(ii)*V(1,3)+ay(ii)*V(2,3)+az(ii)*V(3,3))/(absa(ii));
