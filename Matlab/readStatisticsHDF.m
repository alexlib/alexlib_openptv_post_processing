function [dstr, astr] = readStatisticsHDF(hfile,varargin)
%
...
%             'coswl3','divref','ii','cosulambda1m','cosulambda2m','cosulambda3m'};
%
%
