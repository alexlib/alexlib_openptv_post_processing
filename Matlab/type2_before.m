function [data_large,data_small] = type2_before(large,small,time_interval,R,verbose)
...
%   >> load large_10680
%   >> load small_10680
%   >> selection = type2_before(large_10680,small_10680,10,30,1)
%
...
for i = 1:numTraj,
    ...
    if ~isempty(event)  && event > time_interval,
        ...
        data_large = cat(1,data_large,large(i).uf(event));
