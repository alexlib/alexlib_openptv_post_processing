function varargout = TrajPoint2HDF_v32(hfile,varargin)
% TRAJPOINT2HDF_v8 Reads trajPoint.* files into Matlab and saves them 
% into HDF format.
%           TRAJPOINT2HDF(HFILE) will open GUI to read in specific
...
%
% Example:
%           trajPoint2HDF_v32('trajPoint.hdf')
% or
%
%           trajPoint2HDF_v32('traj.hdf','e:\ptv\mar2004\res\',10000,12000);
%
