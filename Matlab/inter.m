...
%function inter(n,xpix,ypix,time_step)

function store=inter(x1_0,y1_0,z1_0,total_pix,xpix,ypix);
...
store(:,time)=[x1_0 y1_0 z1_0 strain e_val_1 e_val_2 e_val_3 theta_degree total_pix xpix ypix];
...
%theta_degree
 ...
 fprintf ('%2.5f\t %2.5f\t %2.5f\t %2.5f\t %2.5f\t %2.5f\t %2.5f\t %2.5f\t %.2f\t  %10.2f\t  %6.2f\n',store)
