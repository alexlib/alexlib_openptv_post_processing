...
for n=first:last
    ...
    name_rt=['D:\PTV\Working_folder\Exp19b_1211201\res\rt_is.',num2Str(n)];
    ...
    %%%%%%%%%%%% Target files %%%%%%%%%%
    name_t1=['D:\PTV\Working_folder\Exp19b_1211201\Exp19b_12112010\filt_Cam1.',num2Str(n)];
    name_t2=['D:\PTV\Working_folder\Exp19b_1211201\Exp19b_12112010\filt_Cam2.',num2Str(n)];
