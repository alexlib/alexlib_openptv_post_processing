function [data_large,data_small] = type2_ReynoldsStress(quantity_large,quantity_small,large,small,time_interval,close_enough,verbose)
% TYPE2 should solve the problem of complex selections of events and the
% respective flow fields.
% [DATA_LARGE,DATA_SMALL] = ...
%   TYPE2_REYNOLDSSTRESS(QUANTITY_LARGE,QUANTITY_SMALL,LARGE,SMALL,TIME_INTERVAL,CLOSE_ENOUGH,VERBOSE)
% Inputs:
%   quantity_large - one of the quantities, e.g. 'xf','uf', etc.
%   quantity_small = name of the Reynolds stress component,
%   e.g. 'uv', 'uw', or 'vw
...
%   >> load large_10680
%   >> load small_10680
%   >> [data_large,data_small] = type2_ReynoldsStress('uv','vf',large_10680,small_10680,10,20)
%
