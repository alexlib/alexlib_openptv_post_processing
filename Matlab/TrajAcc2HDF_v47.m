function varargout = TrajAcc2HDF_v47(hfile,varargin)
% TRAJACC2HDF_v47 Reads trajAcc.* files with 47 COLUMNS from latest version of
% Beat Luethi PostPTV(tm) software into Matlab and saves them 
% with the HDF format.
%
%    TRAJACC2HDF(HFILE,FILEPATH,FIRSTFILE,LASTFILE)
% Will read trajACC.* files from trajAcc.FIRSTFILE to
% trajAcc.LASTFILE in the directory FILEPATH
%
% Example:
%           trajAcc2HDF_V47('Conv_run90.hdf')
% or
%
%           trajAcc2HDF_V47('conv_run90.hdf','e:\ptv\convection\14july2004\res\',10000,12000);
%
% See also: HELP trajAcc2HDF_V32 READTRAJHDF HDF HDFTOOL 
%
% 
...
% Modified at: 15-Sep-2004
% $Revision: 1.0 $  $Date: 15-Sep-2004 11:03:49$
...
%        f = fscanf(fid,'%g',[32 inf]); % It has two rows now.
        f = fscanf(fid,'%g',[47 inf]); % It has two rows now.
