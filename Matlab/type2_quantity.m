function [data_large,data_small] = type2_quantity(quantity_large,quantity_small,large,small,time_interval,close_enough,verbose)
% TYPE2 should solve the problem of complex selections of events and the
% respective flow fields.
% [DATA_LARGE,DATA_SMALL] = ...
%   TYPE2(QUANTITY_LARGE,QUANTITY_SMALL,LARGE,SMALL,TIME_INTERVAL,CLOSE_ENOUGH,VERBOSE)
% Inputs:
%   quantity_large,quantity_small = name of the quantity, e.g. 'vf'
...
%   >> load large_10680
%   >> load small_10680
%   >> [data_large,data_small] = type2_quantity('uf','vf',large_10680,small_10680,10,20)
%
