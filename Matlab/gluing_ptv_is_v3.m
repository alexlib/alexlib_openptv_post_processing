...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
columns=14;%9;% No of variables in ptv_is files
...
for fig_id=11:11%15
    ...
    switch fig_id
        case 1
            ...
            first=100001;last=100969;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp3b_10112010\']; 
        ...
        case 2
            ...
            first=100001;last=101686;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp11_12112010\'];
        ...
        case 3
            ...
            first=100001;last=103710;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp12_12112010\'];
        ...
        case 4
            ...
            first=1;last=750;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp18b_06112010\'];
        ...
        case 5
            ...
            first=1;last=1295;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp19b_09112010\'];
        ...
        case 6
            ...
            first=1;last=3890;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp21b_09112010\'];
        ...
        case 7
            ...
            first=1;last=5457;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp22multi_09112010\'];
        ...
        case 8
            ...
            first=1;last=3416;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp25b_09112010\'];
        ...
        case 9
            ...
            first=1;last=1684;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp28b_09112010\'];
        ...
        case 10
            ...
            first=1;last=5457;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp29b_09112010\'];
        ...
        case 11
            ...
            first=1;last=3039;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp30b_09112010\'];
        ...
        case 12
            ...
            first=1;last=2832;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp31b_09112010\'];
        ...
        case 13
            ...
            first=1;last=2525;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp32b_09112010\'];
        ...
        case 14
            ...
            first=1;last=1793;
            name_root=['\\Ifu-gwh-disk\hydromechanik3\Beat_Colloid\test_cases\Extended_ptv_is_Exp33b_09112010\'];
    ...
    for i=first:last
        ...
        tmp = fscanf(fid, '%i %i %f %f %f %f %f %f %f %f %f %f %f %f', [columns num_points]);
        A=tmp';
            ...
            while go==1
                ...
                if num_in_traj>last-first-i+1 | si(1,1)>last-first-1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    ...
                    if si(1,1)>min_length %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                        ...
                        update(columns);% Not to read the same row twice in the next frame?
                    end
                elseif old_num_in_traj==num_in_traj%%%%%%%%% Traj dies somewhere in the frame
                    go=0;
                    if si(1,1)>min_length
...
if i<last-first+1
    if ptv(i,j,2)>-1 & ptv(i+1,ptv(i,j,2)+1,columns+1)==0
        ...
        traj(num_in_traj,1)=i+1;% here frame i become dynamic and moves on
...
for i=1:length(traj)
    ...
    S_ij(i)= ptv(traj(i,1),traj(i,2),10);
    L1(i)= ptv(traj(i,1),traj(i,2),11);
    L2(i)= ptv(traj(i,1),traj(i,2),12);
    L3(i)= ptv(traj(i,1),traj(i,2),13);
    vel(i)= ptv(traj(i,1),traj(i,2),14);
