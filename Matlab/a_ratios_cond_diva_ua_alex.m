function res=a_ratios_cond_diva_ua_alex(first,last,tail,stepSize,mode);

% Stopped due to missing dadx, Nov 14,
...
case 'HDF'
    ...
    stepSize = 1;
    curdir = cd;
    hdf_file = [curdir(1),':\Matlab\Alex\HDF\0104_water.hdf'];
    nBins = 100;
