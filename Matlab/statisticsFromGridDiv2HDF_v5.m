function statisticsFromGridDiv2HDF_v5(dataNum,dataset)
...
hdfsd('setattr',sd_id,'fields',fieldname_list);
...
sds_id = hdfsd('create',sd_id,'gridData','float64',rank,dimsizes)
...
status = hdfsd('writedata', sds_id, start, stride, edges, data);
if status == -1
